...
public class Constants {
    ...
    public static final double kArmPositionConversionFactor = 2.0 * Math.PI;
    public static final double kArmVelocityConversionFactor = 60 * (2.0 * Math.PI); // From RPM to Radians per second
    ...
    public static final double kAngleCutoffRadians = 3.0 * Math.PI / 4.0;
